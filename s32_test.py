...
for rotate in [0,90,180,270]:
	with FBTFTdevice("sainsmart32", dev={ 'rotate':rotate, 'gpios':GPIOS, 'debug':get_debug() }, autoload=True) as dev:
		console_test()
		if rotate == 0:
			fbtest()
			startx_test()
...
for rotate in [0,90,180,270]:
	...
	with FBTFTdevice("flexfb", devname="flexpfb", dev={ 'rotate':rotate, 'gpios':GPIOS, 'debug':get_debug() }, drv=flexfb_drv_args) as dev:
		if rotate in [0,180]:
			mplayer_test(240, 320)
		else:
			mplayer_test(320, 240)
