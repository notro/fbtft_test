...
for rotate in [0,90,180,270]:
	with FBTFTdevice("hy28a", dev={'rotate':rotate, 'gpios':"reset:25,led:18", 'debug':get_debug()}, autoload=True) as dev:
		console_test()
...
for rotate in [0,270,180]:
	...
	with FBTFTdevice("flexfb", devname="flexfb", dev={ 'rotate':rotate, 'mode':3, 'startbyte':0x70, 'debug':get_debug() }, drv=flexfb_drv_args) as dev:
		if rotate in [0,180]:
			mplayer_test(240, 320)
		else:
			mplayer_test(320, 240)
